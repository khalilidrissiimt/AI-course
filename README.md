...
- <span style="color: blue;">**Lecture 0:** Introduction to AI - A foundational start for the entire course.
- <span style="color: blue;">**Lecture 1:** Linear Regression - Understanding the basics of statistical modeling.
